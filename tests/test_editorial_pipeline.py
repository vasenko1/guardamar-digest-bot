...
class PipelineTest(unittest.TestCase):
    ...
    def test_editorial_title_rules_preserve_intent_and_facts(self):
        ...
        self.assertEqual(
            ...
            "Косметолог с медицинским образованием, Санта-Пола",
        )
        self.assertEqual(
            _validate_showcase_title(
        ...
        self.assertEqual(
            _validate_showcase_title(
                "Рихтовщик, кузовщик, сварщик, подготовщик",
                "В автосервис требуются рихтовщик, кузовщик, сварщик и подготовщик",
            ),
            "Рихтовщик, кузовщик, сварщик, подготовщик",
        )
        self.assertEqual(
            _compact_checkpoint_title(
                "Рихтовщик, кузовщик, сварщик, подготовщик",
                "Мы расширяемся и ищем ответственных специалистов: рихтовщик, кузовщик, сварщик, подготовщик",
                "Работа и вакансии",
            ),
            "Рихтовщик, кузовщик, сварщик, подготовщик",
        )
